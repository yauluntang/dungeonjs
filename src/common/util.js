...
Util.getFrames = function( cell_width, cell_height, width, height ){
    var x = Math.floor(width / cell_width);
    var y = Math.floor(height / cell_height);
    var list = [];
...
Util.spriteFrames = function( file, cell_width, cell_height, width, height ){
    var x = Math.floor(width / cell_width);
    var y = Math.floor(height / cell_height);
    var list = [];
...
Util.arrayFromTo = function( fromNum, toNum ){
    var list = [];
...
Util.arrayFromCount = function( fromNum, count ){
    var list = [];
    for ( var i = fromNum; i < fromNum + count; i ++ ){
        list.push(i);
    }
    return list;
}
